...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" itemprop="video" itemscope itemtype="http://schema.org/VideoObject" >
...
<meta name="msvalidate.01" content="B9DA583FFDBF43E6EDBA4230157876F1" />
<meta name="propeller" content="5de00228e52837613aae7d7fc11f435f">
<title>{if !empty($seotitle)}{$seotitle|escape}{else}{$site_name}{/if}</title><meta name="description" content="{if !empty($seodescription)}{$seodescription|escape}{else}{$meta_description}{/if}" /><meta itemprop="keywords" name="keywords" content="{if !empty($seokeywords)}{$seokeywords|escape}{else}{$meta_keywords}{/if}" />
...
<!-- Header -->
 <div id="wrapper">
  <div id="header">
	 <div id="logo">
	 <a itemprop="url" href="{$baseurl}/"><img itemprop="image" src="{$imgurl}/logo.png" alt="{$site_name}" /></a>
	 </div>
