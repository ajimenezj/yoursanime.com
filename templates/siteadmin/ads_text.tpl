     <div id="rightcontent">
        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    <a href="ads.php?m=edittext&AID={$advs[i].adv_id}">Edit</a><br>
                    <a href="ads.php?m=text&a=delete&AID={$advs[i].adv_id}" onClick="javascript:return confirm('Are you sure you want to delete this advertising text?');">Delete</a><br>
                    {if $advs[i].status == '1'}
                    <a href="ads.php?m=text&a=suspend&AID={$advs[i].adv_id}" onClick="javascript:return confirm('Are you sure you want to suspend this advertising text?');">Suspend</a>
                    {else}
                    <a href="ads.php?m=text&a=activate&AID={$advs[i].adv_id}" onClick="javascript:return confirm('Are you sure you want to activate this advertising text?');">Activate</a>
                    {/if}
                    <br>
                </td>
            </tr>
