     <div id="rightcontent">
        ...
        <div id="simpleForm">
        <form name="edit_ad" method="POST" action="nuevo.php?m=prerolledit&ID={$ad.ID}">
        <fieldset style="font-size:11px">
        <legend>Edit random preroll ad</legend>
	    ...
	    <input type="text" name="link" size="40" maxlength="100" value="{$ad.link}" /><br />
	 ...
	 <fieldset style="font-size:11px">
		...
		<tr><td align="center" style="padding: 0px 5px">{$ad.views}</td>
		<td align="center" style="padding: 0px 5px">{$ad.hits}</td>
		<td align="center" style="padding: 0px 5px">{$ad.CTR} %</td></tr>
		</table>
		</center>
	 </fieldset>
	...
	<div style="text-align: center;">
	    ...
	    <input type="submit" name="submit" value="Update Ad" class="button">
        </div>
        </form>
        </div>
        </div>
