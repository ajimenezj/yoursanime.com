     <div id="rightcontent">
        ...
        <h2>Overlay Ads</h2>
        <div id="simpleForm">
        <form name="new_ad" method="POST" action="nuevo.php?m=overlaynew">
        <fieldset style="font-size:11px">
        <legend>Create new overlay Ad</legend>               
	...
	<div style="text-align: center;">
	    <input type="submit" name="submit" value="Create Overlay Ad" class="button">
        </div>
        </form>
        </div>
        </div>
