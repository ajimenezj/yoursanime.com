     <div id="rightcontent">
        ...
        <h2>Edit HTML AD</h2>
        <div id="simpleForm">
        <form name="edit_ad" method="POST" action="nuevo.php?m=anyadedit&ID={$data.ID}">
		...
		<option value="midroll"{if $data.ad_type eq 'midroll'} selected="selected"{/if}>Midroll</option>
	    </select><br />
	...
	<div style="text-align: center;">
	    <input type="submit" name="submit" value="Create or Update Ad Settings" class="button">
        </div>
        </form>
        </div>
        </div>
