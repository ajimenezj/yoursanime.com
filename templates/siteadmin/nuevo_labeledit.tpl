     <div id="rightcontent">
       ...
       <div id="right">
        ...
        <div id="simpleForm">
        <form name="new_ad" method="POST" action="nuevo.php?m=labeledit&ID={$ad.ID}">
        <fieldset style="font-size:11px">
        <legend>Edit ticker message</legend>               
	    ...
	    <label for="opacity">Scroll Speed (1-10): </label>	
	...
	<div style="text-align: center;">
	    <input type="submit" name="submit" value="Update Ticker Message" class="button">
        </div>
        </form>
        </div>
        </div>
