...
$uid	= ( isset($_REQUEST['UID']) && is_numeric($_REQUEST['UID']) ) ? mysql_real_escape_string($_REQUEST['UID']) : NULL;
...
if($rs->recordcount()>0) {
	...
	for ( $k=1; $k<=$tpage; $k++ )
		$page_link .= "<a href='group_members.php?UID=" .$uid. "&page=" .$k. "&type=" .$type. "'>$k</a>&nbsp;&nbsp;";
	//END PAGING
}
